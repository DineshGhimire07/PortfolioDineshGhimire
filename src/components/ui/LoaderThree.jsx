...
export default function LoaderThree({ 
      ...
      <div key={rowIndex} className="flex">
        {row.map((cell, colIndex) => (
          <div
            ...
            className={`${config.cellSize} border border-zinc-800 transition-all duration-100 ${
              cell.filled 
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="mb-6">
        <div className={`border-2 border-zinc-800 bg-black ${config.padding} transition-colors`}>
          {renderGrid()}
        </div>
      </div>
      ...
      {showLoadingText && (
        <div className="text-center">
          <p className="text-white uppercase tracking-widest text-sm font-medium transition-colors">{loadingText}</p>
        </div>
      )}
    </div>
  )
